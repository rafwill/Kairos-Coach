            ...
            if pre_id is not None:
                ...
                messages.insert(len(messages) - 1, {
                    ...
                    "content": (
                        ...
                        "FORMATO OBLIGATORIO: cada bullet = valor numerico real + dos puntos + tu analisis como coach.\n"
                        "- Body battery: escribe el balance neto y los valores cargado/drenado, "
                        "luego explica en tus propias palabras que significa para el rendimiento ese dia.\n"
                        "  Ejemplo de formato (no de contenido): '- Body Battery: -16 puntos (cargado 69 / drenado 85): [tu analisis aqui]'\n"
                        "- Sueno: escribe duracion y puntuacion, luego interpreta la calidad del descanso. "
                        "Menciona las fases (profundo/ligero/REM) si estan en los datos.\n"
                        "  Ejemplo de formato: '- Sueno: 7h 10min (86/100): [tu analisis aqui]'\n"
                        "- HRV: escribe el valor en ms, luego interpreta como indicador del estado del sistema nervioso autonomo. "
                        "Si no hay datos de HRV: una linea indicandolo.\n\n"
