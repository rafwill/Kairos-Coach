            ...
            if pre_id is not None:
                ...
                messages.insert(len(messages) - 1, {
                    ...
                    "content": (
                        ...
                        "- Body battery: balance cargado/drenado e interpretacion de la energia disponible.\n"
                        "- Sueno: duracion total, fases (profundo/ligero/REM) y puntuacion si estan disponibles.\n"
                        "- HRV: valor nocturno (ms) e interpretacion como indicador de recuperacion del SNA. "
                        "Si no hay datos de HRV para esta fecha indicalo brevemente.\n\n"
