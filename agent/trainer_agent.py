            ...
            if pre_id is not None:
                ...
                messages.insert(len(messages) - 1, {
                    ...
                    "content": (
                        ...
                        "OBLIGATORIO: cada bullet empieza con el valor numerico real y luego la interpretacion.\n"
                        "- Body battery: '-16 puntos (cargado 69 / drenado 85): interpretacion coaching.' "
                        "Usa los valores exactos del bloque BODY BATTERY. Interpreta el balance como energia neta.\n"
                        "- Sueno: '7h 10min (86/100): interpretacion coaching.' "
                        "Incluye fases (profundo X min, ligero Y min, REM Z min) si estan disponibles.\n"
                        "- HRV: '55 ms: interpretacion coaching.' "
                        "Si no hay datos de HRV para esta fecha indicalo en una sola linea.\n\n"
